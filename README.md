...
A demo application built with Ruby on Rails and react.js(original PingCRM written in fronted with vue.js) to illustrate how **[Inertia.js](https://inertiajs.com/)** works.
